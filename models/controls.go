...
func (r *Rubik_cube) My() *Rubik_cube {
	...
	tmp_r := Rubik_cube{
		Top_Layer: Top_Layer{
			...
			Left_mid:     r.Top_Layer.Left_mid,
			Left_back:    r.Top_Layer.Left_back,
			Mid_front:    Mid_cubit{Top_face: r.Top_Layer.Mid_back.Front_face, Front_face: r.Top_Layer.Mid_back.Top_face},
			Mid_back:     Mid_cubit{Top_face: r.Bottom_Layer.Mid_front.Front_face, Front_face: r.Bottom_Layer.Mid_front.Top_face},
			Right_front:  r.Top_Layer.Right_front,
		...
		Middle_Layer: Middle_Layer{
			...
			Right_front:        r.Middle_Layer.Right_front,
			Right_back:         r.Middle_Layer.Right_back,
			Center_front_cubit: r.Top_Layer.Center_cubit,
			Center_back_cubit:  r.Bottom_Layer.Center_cubit,
			Center_right_cubit: r.Middle_Layer.Center_right_cubit,
			Center_left_cubit:  r.Middle_Layer.Center_left_cubit,
		},
		Bottom_Layer: Bottom_Layer{
